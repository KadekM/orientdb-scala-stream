package orientdb.stream.wrappers
...
private[stream] object SmartOSQLNonBlockingQuery {
...
private[stream] class SmartOSQLNonBlockingQuery[A](query: String)(implicit ec: ExecutionContext)
